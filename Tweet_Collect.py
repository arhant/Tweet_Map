    ...
    def on_data(self, data):
        ...
        try:
            ...
            if place is not None:
                ...
                with open('mine1', 'a') as f:
                    f.write(data_string)

                   
                try:
                    client.index(index='cloud_tweet1', doc_type='twitter', body={
                    'content': tweet,
...
if __name__ == '__main__':
    ...
    stream.filter(track=['trump','giveaway','messi','ronaldo','bush','thursday','josh brown','#indvsnz','samsung','apple',
